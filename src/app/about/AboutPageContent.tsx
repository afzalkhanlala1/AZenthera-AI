        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <AnimatedSection>
            ...
            <p className="text-text-muted text-lg md:text-xl text-center max-w-2xl mx-auto mt-6">
              Two NUST-trained Mechatronics engineers building intelligent systems that solve real business problems —
            ...
            <AnimatedSection delay={0.1}>
              <div className="space-y-6">
                <p className="text-text-muted text-lg leading-relaxed">
                  AZenthera AI was founded by two NUST-trained Mechatronics engineers who share a passion for building
              ...
              <div className="grid grid-cols-2 gap-4">
                {aboutHighlights.map((hl) => (
                  <div key={hl.title} className="glass-card rounded-2xl p-6 text-center">
                    ...
                    <h4 className="text-white font-semibold text-sm">{hl.title}</h4>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-2">
                      {member.highlights.map((hl) => (
                        <div key={hl} className="flex items-start gap-2 text-sm text-white/80">
