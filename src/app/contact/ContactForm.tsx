    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          name="name"
          required
          className="w-full px-4 py-3 rounded-xl bg-surface border border-white/10 text-white placeholder-text-muted/60 focus:outline-none focus:border-accent/50 transition-colors"
      ...
      <div>
        ...
        <select
          ...
          name="subject"
          required
          className="w-full px-4 py-3 rounded-xl bg-surface border border-white/10 text-white focus:outline-none focus:border-accent/50 transition-colors appearance-none cursor-pointer"
          style={{
      ...
      <div>
        ...
        <textarea
          ...
          required
          rows={5}
          className="w-full px-4 py-3 rounded-xl bg-surface border border-white/10 text-white placeholder-text-muted/60 focus:outline-none focus:border-accent/50 transition-colors resize-none"
