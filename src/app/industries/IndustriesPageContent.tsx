          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <AnimatedSection delay={0.1}>
              <div className="glass-card rounded-2xl p-8">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Domain Expertise</h3>
            ...
            <AnimatedSection delay={0.15}>
              <div className="glass-card rounded-2xl p-8">
                <div className="text-3xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-white mb-3">Faster Time to Value</h3>
                <p className="text-text-muted leading-relaxed">
            ...
            <AnimatedSection delay={0.2}>
              <div className="glass-card rounded-2xl p-8">
                <div className="text-3xl mb-4">📈</div>
                <h3 className="text-xl font-bold text-white mb-3">Measurable Impact</h3>
                <p className="text-text-muted leading-relaxed">
