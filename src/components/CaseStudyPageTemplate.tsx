        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6 text-text-muted mb-6">
              <span>
                <strong className="text-white/90">Client:</strong>{" "}
                {caseStudy.client}
              </span>
              <span>
      ...
      <AnimatedSection className="py-20" delay={0.1}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-card rounded-2xl p-8 border-l-4 border-rose-500/60">
            <p className="text-white/90 leading-relaxed">{caseStudy.problem}</p>
          </div>
        </div>
      </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-card rounded-2xl p-8 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="h-48 rounded-xl bg-surface/80 border border-white/5 flex items-center justify-center">
